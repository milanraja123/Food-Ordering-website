...
if (isset($_GET['id'])) {
    ...
    $sql2 = "SELECT * FROM `food-details` WHERE id=$id";
            ...
            <table class="tab">
                ...
                <tr>
                    <td>
                        ...
                        <input type="submit" name="submit" value="Update category" class="btn-secondary" style="padding: 3% 1%;">
                    </td>
                </tr>
            </table>
        </form>
